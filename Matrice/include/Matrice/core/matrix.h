...
public:
	...
	MATRICE_HOST_FINL   Matrix_(const_initlist _list) noexcept : _Mybase(_list) {}
...
public:
	...
	MATRICE_HOST_INL Myt_reference operator= (const_initlist _list) { return _Mybase::operator=(_list); }
