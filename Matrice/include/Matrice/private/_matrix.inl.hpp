...
template<typename _Rhs,
	     typename value_t = std::enable_if<std::is_arithmetic<typename _Rhs::value_t>::value, typename _Rhs::value_t>::type,
	     typename     _Op = Expr::EwiseBinaryExpr<_Rhs, _Rhs, Expr::Op::EwiseSum<value_t>>>
MATRICE_GLOBAL_INL auto operator+ (const value_t& _scalar, const _Rhs& _opd) { return _Op(_scalar, _opd); }
...
template<typename _Rhs,
	     typename value_t = std::enable_if<std::is_arithmetic<typename _Rhs::value_t>::value, typename _Rhs::value_t>::type,
	     typename     _Op = Expr::EwiseBinaryExpr<_Rhs, _Rhs, Expr::Op::EwiseMin<value_t>>>
MATRICE_GLOBAL_INL auto operator- (const value_t& _scalar, const _Rhs& _opd) { return _Op(_scalar, _opd); }
template<typename _Lhs, class _Rhs,
	     typename value_t = std::common_type_t<typename _Lhs::value_t, typename _Rhs::value_t>,
...
template<typename _Rhs,
	     typename value_t = std::enable_if<std::is_arithmetic<typename _Rhs::value_t>::value, typename _Rhs::value_t>::type,
	     typename     _Op = Expr::EwiseBinaryExpr<_Rhs, _Rhs, Expr::Op::EwiseMul<value_t>>>
MATRICE_GLOBAL_INL auto operator* (const value_t& _scalar, const _Rhs& _opd) { return _Op(_scalar, _opd); }
template<typename _Lhs, class _Rhs,
		 typename value_t = std::common_type_t<typename _Lhs::value_t, typename _Rhs::value_t>, 
...
template<typename _Rhs, 
	     typename value_t = std::enable_if<std::is_arithmetic<typename _Rhs::value_t>::value, typename _Rhs::value_t>::type,
	     typename     _Op = Expr::EwiseBinaryExpr<_Rhs, _Rhs, Expr::Op::EwiseDiv<value_t>>>
MATRICE_GLOBAL_INL auto operator/ (const value_t& _scalar, const _Rhs& _opd) { return _Op(_scalar, _opd); }
